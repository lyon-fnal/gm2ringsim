...
#ifndef G2EQEMFIELDWITHEDM_hh
#define G2EQEMFIELDWITHEDM_hh

#include "Geant4/G4EquationOfMotion.hh"

class G4ElectroMagneticField;

class g2EqEMFieldWithEDM : public G4EquationOfMotion
{
  public:  // with description

    g2EqEMFieldWithEDM(G4ElectroMagneticField *emField );

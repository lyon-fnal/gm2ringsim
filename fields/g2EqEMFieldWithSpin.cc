...
#include "g2EqEMFieldWithSpin.hh"
#include "Geant4/G4ElectroMagneticField.hh"
#include "Geant4/G4ThreeVector.hh"
#include "Geant4/globals.hh"

g2EqEMFieldWithSpin::g2EqEMFieldWithSpin(G4ElectroMagneticField *emField )
  : G4EquationOfMotion( emField )
{
  anomaly = 0.0011659208;
}

g2EqEMFieldWithSpin::~g2EqEMFieldWithSpin()
{
} 

void  
g2EqEMFieldWithSpin::SetChargeMomentumMass(G4double particleCharge, // e+ units
                                            G4double MomentumXc,
...
void
g2EqEMFieldWithSpin::EvaluateRhsGivenB(const G4double y[],

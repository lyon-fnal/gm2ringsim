...
#ifndef G2EQEMFIELDWITHSPIN_hh
#define G2EQEMFIELDWITHSPIN_hh

#include "Geant4/G4EquationOfMotion.hh"

class G4ElectroMagneticField;

class g2EqEMFieldWithSpin : public G4EquationOfMotion
{
  public:  // with description

    g2EqEMFieldWithSpin(G4ElectroMagneticField *emField );
